...
def get_cbm_LLM_sequential(mode=None, max_len=None, batch_size=None, model_name=None, num_epochs=None, data_type=None, optimizer_lr=None):
    ...
    model_name = 'bert-base-uncased' if model_name is None else model_name # 'bert-base-uncased' / 'roberta-base' / 'gpt2'
    ...
    data_type = "aug_gen_imdb" if data_type is None else data_type # "manual_imdb"/"aug_manual_imdb"/"gen_imdb"/"aug_gen_imdb"
    # Load data
