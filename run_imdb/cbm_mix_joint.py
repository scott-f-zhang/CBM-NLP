...
def get_cbm_mix_joint(mode=None, max_len=None, batch_size=None, model_name=None, num_epochs=None, data_type=None, optimizer_lr=None):
    # Enable concept or not
    mode = 'joint' if mode is None else mode

    # Define the paths to the dataset and pretrained model
    # model_name = "microsoft/deberta-base"
    model_name = 'lstm' if model_name is None else model_name # 'bert-base-uncased' / 'roberta-base' / 'gpt2' / 'lstm'
